...
func PushAndRunTests(host, testDir string) error {
	...
	err = RunCommand("godep", "go", "test", "github.com/cnaize/cadvisor/integration/tests/...", "--host", host, "--port", portStr)
	if err != nil {
		return err
	}
...
func Run() error {
	...
	err := RunCommand("godep", "go", "build", "github.com/cnaize/cadvisor")
	if err != nil {
		return err
	}
	defer func() {
